...
export class CharactersService {
  constructor(
    ...
    private charactersStatsRepository: Repository<CharacterStats>,
  ...
  async create(createCharacterDto: CreateCharacterDto, @Req() req: Request) {
    ...
    const characterStats: CharacterStats = new CharacterStats();
    ...
    await this.charactersStatsRepository.save(characterStats);
  }
